...
//  if(istrigger<1) return;
  ...
  for(int i=0;i<nMax;i++) {
    ...
    if(trayId==122){//vpd East
      ...
      mCellData.nHitsPoss[ntofhits] = globalTrack->nHitsPoss(); // Daniel
...
void StBTofNtupleMaker::bookNtuples(){
  ...
  mCellTuple->Branch("nHitsPoss",&mCellData.nHitsPoss,"nHitsPoss[nTofHits]/I"); // Daniel
